  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-sm flex flex-col justify-center">
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-sm flex flex-col justify-center">
          <h3 className="text-slate-400 font-medium">Active Orders</h3>
          <p className="text-4xl font-bold text-emerald-500 mt-2">{orderCount || 0}</p>
        </div>
      </div>
    </div>
  );
